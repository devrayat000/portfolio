...
import { defaultEvents, useOnEnter, useOnExit } from "https://framer.com/m/framer/default-utils.js";
var Indicators;
(function(Indicators) {
    Indicators["DotWave"] = "Dots";
    Indicators[// Spinner = "Spinner",
    "Material"] = "Material";
    Indicators["IOS"] = "iOS";
})(Indicators || (Indicators = {
}));
const angleInRadians = (angleInDegrees)=>(angleInDegrees - 90) * (Math.PI / 180)
;
...
function DotWave({ color , animation  }) {
    ...
    const transition = animation.type === "spring" ? animProps : {
        ...animProps,
        ease,
        duration
    };
    ...
    return(/*#__PURE__*/ _jsx(motion.svg, {
        ...
        animate: "show",
        children: circles.map((circle)=>/*#__PURE__*/ _jsx(motion.circle, {
                style: {
                    fill: color
                },
                variants: {
...
function IOS({ color , animation  }) {
    ...
    return(/*#__PURE__*/ _jsx(motion.svg, {
        ...
        children: lineOpacities.map((lineKeyframes, i)=>/*#__PURE__*/ _jsx(motion.g, {
                initial: {
                    opacity: lineKeyframes[0]
                },
                animate: {
                    opacity: lineKeyframes
                },
                transition: {
                    ...animation,
                    loop: Infinity,
...
function getIndicator(indicator, props) {
    switch(indicator){
        case Indicators.DotWave:
            return(/*#__PURE__*/ _jsx(DotWave, {
                ...props
            }));
        case Indicators.Material:
            return(/*#__PURE__*/ _jsx(Material, {
                ...props
            }));
        case Indicators.IOS:
            return(/*#__PURE__*/ _jsx(IOS, {
                ...props
            }));
 ...
 */ export function Loading(props) {
    ...
    useOnEnter(()=>{
        resetOpacity();
        if (hasDuration) handlers.current = [
...
export const __FramerMetadata__ = {"exports":{"handleTimeout":{"type":"function","annotations":{"framerContractVersion":"1"}},"Loading":{"type":"reactComponent","name":"Loading","slots":[],"annotations":{"framerSupportedLayoutWidth":"fixed","framerContractVersion":"1","framerSupportedLayoutHeight":"fixed","framerIntrinsicHeight":"40","framerIntrinsicWidth":"40"}}}}
