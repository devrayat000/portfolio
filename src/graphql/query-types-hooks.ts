...
export interface AzureStorageImageFieldOutputType
  extends AzureStorageImageFieldOutput {
...
export type ProjectFragmentFragment = {
  ...
  description?:
    | { __typename?: 'Project_description_Document'; document: any }
    | null
    | undefined
  images?:
    | Array<{
...
>(
  ...
  useQuery<GetProjectByIdQuery, TError, TData>(
    ...
    fetcher<GetProjectByIdQuery, GetProjectByIdQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
...
export const useGetImagesQuery = <TData = GetImagesQuery, TError = unknown>(
  ...
  useQuery<GetImagesQuery, TError, TData>(
    ...
    fetcher<GetImagesQuery, GetImagesQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      GetImagesDocument,
      variables
...
export const GetImageByIdDocument = `
  ...
  image(where: {id: $id}) {
    ...
    ${ImageFragmentFragmentDoc}`
export const useGetImageByIdQuery = <
  TData = GetImageByIdQuery,
  TError = unknown
>(
  dataSource: { endpoint: string; fetchParams?: RequestInit },
  variables: GetImageByIdQueryVariables,
  options?: UseQueryOptions<GetImageByIdQuery, TError, TData>
) =>
  useQuery<GetImageByIdQuery, TError, TData>(
    ['GetImageById', variables],
    fetcher<GetImageByIdQuery, GetImageByIdQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
